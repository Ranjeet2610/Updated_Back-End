...
if (marketIds){
    ...
    Request.post({
        ...
        // console.log(oddsData[0].result[0])

        // console.log(oddsData[0].result[0].marketId,oddsData[0].result[0].status)
                    // if(oddsData[0].result[0].status === "CLOSED"){
           
                    //     console.log(oddsData[0].result[0].runners[0].selectionId,oddsData[0].result[0].runners[0].status)

                    // }
                    if( (oddsData[0].result[0] !== undefined) ){


        if(oddsData[0].result[0].status === "CLOSED"){

            // console.log(oddsData[0].result[0].runners[0].selectionId,oddsData[0].result[0].runners[0].status)
            oddsData[0].result[0].runners.map((item1,index)=>{
